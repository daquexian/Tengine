...
using namespace CastFP32Impl32;

void RegisterCastFP32(void)
{
    NodeOpsRegistryManager::RegisterOPImplementor("arm32", "Cast", CastFP32Impl32::SelectFunc, CastFP32Impl32::default_prio);
}
