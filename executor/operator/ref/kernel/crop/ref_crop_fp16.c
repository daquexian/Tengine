...
int ref_crop_fp16(fffffp16* input, fffffp16* output,ref_crop_param* param)
{
/* for arm32 && x86 */
                        ...
                        for(int h = 0; h < param->oDataH; h++)
                        {
                            ...
                            for(int w = 0; w < param->oDataW; w++)
                            {
                                ...
                                output[n * param->oDataC * param->oDataH * param->oDataW + c * param->oDataH * param->oDataW + h *param->oDataW + w] =
                                    input[n * param->iDataC * param->iDataH * param->iDataW + c * param->iDataH * param->iDataW + i_h * param->iDataW + i_w];
                            }
                        }
                    }
                }
                ...
                for(int c = 0; c < param->oDataC; c++){
                    ...
                    for(int h = 0; h < param->oDataH; h++){
                        ...
                        for(int w = 0; w < param->oDataW; w++){
                            ...
                            output[n * param->oDataC * param->oDataH * param->oDataW + c * param->oDataH * param->oDataW + h * param->oDataW + w] =
                                input[n * param->iDataC * param->iDataH * param->iDataW + i_c * param->iDataH * param->iDataW + i_h * param->iDataW + i_w];
                        }
                    }
                }
            }
